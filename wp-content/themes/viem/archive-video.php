 ...
 * @package dawn
 */
$layout = viem_get_theme_option('videos-layout', 'full-width');
$sidebar = viem_get_theme_option('videos-sidebar', 'main-sidebar');
$style = viem_get_theme_option('videos-style', 'grid'); // list || grid || masonry
...
if( $style == 'grid' || $style == 'masonry' ){
	$columns = viem_get_theme_option('videos-columns', 4);
}
					...
					<div class="row">
						<div class="col-md-12">
							...
							<?php
								...
								echo '<div class="viem-message-renderer"><div class="message-renderer align-center">'. sprintf(esc_html__("This %s doesn't have any video", 'viem'), get_the_archive_title()) .'</div></div>';
							endif;
							?>
						</div>
					</div><!-- /.row -->
