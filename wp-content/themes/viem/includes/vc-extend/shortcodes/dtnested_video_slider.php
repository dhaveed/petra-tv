...
vc_map(
	array(
		'base' => 'dtnested_video_slider',
		'name' => esc_html__( 'Video Slider', 'viem' ),
		"category" => esc_html__( "DawnThemes", 'viem' ),
		'description' => esc_html__( 'Video player with slider', 'viem' ),
		'class' => 'dt-vc-element dt-vc-element-dtnested_video_slider',
		'icon' => 'dt-vc-icon-dtnested_video_slider',
		'show_settings_on_create' => true,
		'is_container' => true,
		'js_view' => 'DTVCVideoSlider',
		'params' => array(
			array(
				'type' => 'textfield',
...
<div class="wpb_tabs_holder wpb_holder clearfix vc_container_for_children">
	<ul class="tabs_controls">
		...
		'default_content' => '
[dtsingle_video_slider_item title="' . esc_html__( 'Item 1', 'viem' ) . '" tab_id="' . time() . '-1-' . rand( 0, 100 ) . '"][/dtsingle_video_slider_item]
[dtsingle_video_slider_item title="' . esc_html__( 'Item 2', 'viem' ) . '" tab_id="' . time() . '-2-' . rand( 0, 100 ) . '"][/dtsingle_video_slider_item]
[dtsingle_video_slider_item title="' . esc_html__( 'Item 3', 'viem' ) . '" tab_id="' . time() . '-3-' . rand( 0, 100 ) . '"][/dtsingle_video_slider_item]
					  ' ) );

vc_map(
	array(
		'name' => esc_html__( 'Video slider Item', 'viem' ),
		'base' => 'dtsingle_video_slider_item',
		'allowed_container_element' => 'vc_row',
		'is_container' => true,
		'content_element' => false,
		"category" => esc_html__( "DawnThemes", 'viem' ),
		'js_view' => 'DTVCVideoSliderItem',
		'params' => array(
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Title', 'viem' ),
...
class WPBakeryShortCode_DTnested_Video_Slider extends WPBakeryShortCode_VC_Tabs {
	...
	public function getTabTemplate() {
		return '<div class="wpb_template">' .
			do_shortcode( '[dtsingle_video_slider_item title="' . DTVC_ITEM_TITLE . '" tab_id=""][/dtsingle_video_slider_item]' ) .
			'</div>';
	}
}


class WPBakeryShortCode_DTSingle_Video_Slider_Item extends WPBakeryShortCode {
	/**
	 * Find html template for shortcode output.
	 */
	protected function findShortcodeTemplate() {
