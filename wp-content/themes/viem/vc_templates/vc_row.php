...
if (vc_shortcode_custom_css_has_property( $css, array( 'background') ) || $video_bg || $parallax) {
...
if(isset($wrap_type) && 'in_container'===$wrap_type)
	echo '<div class="container">';
echo '<div ' . implode( ' ', $wrapper_attributes ) . '>';
if(isset($wrap_type) && 'wrap_container'===$wrap_type)
	echo '<div class="container">';
...
if(isset($wrap_type) && 'in_container'===$wrap_type)
	echo '</div>';
echo viem_print_string( $after_output );
