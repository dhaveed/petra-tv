...
if(!class_exists('DawnThemes_Admin')):
class DawnThemes_Admin {
	public function __construct(){
		/**
		 * Theme Options API
		 */
		include_once (dirname( __FILE__ ) . '/theme-options-api.php');
		// Import Demo
	...
	public function mce_external_plugins($plugins){
		$plugins['dawnthemes_tooltip'] = DTINC_ASSETS_URL. '/js/tooltip_plugin.js';
		return $plugins;
	}
