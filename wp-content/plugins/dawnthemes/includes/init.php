...
if (! class_exists ( 'DawnThemesInit' )) :
	class DawnThemesInit {
		...
		public function init(){
			...
			add_shortcode('dawnthemes_tooltip',array(&$this,'dt_tooltip_shortcode'));
		...
		private function _includes() {
			...
			//Visual Composer api
			include_once (DTINC_DIR . '/vc-extend/visual-composer-api.php');
