...
;(function ($) {
	...
	window.DTVCCarousel = window.VcTabsView.extend({
		render:function () {
            window.DTVCCarousel.__super__.render.call(this);
            return this;
        },
        ready:function (e) {
            window.DTVCCarousel.__super__.ready.call(this, e);
            return this;
        },
	...
	window.DTVCCarouselItem = window.VcTabView.extend({
		render:function () {
            window.DTVCCarouselItem.__super__.render.call(this);
            return this;
        },
        ready:function (e) {
            window.DTVCCarouselItem.__super__.ready.call(this, e);
            return this;
        },
        cloneModel:function (model, parent_id, save_order) {
            var shortcodes_to_resort = [],
	...
	window.DTVCTimeline = window.VcTabsView.extend({
		render:function () {
            window.DTVCTimeline.__super__.render.call(this);
            var params = this.model.get('params');
            this.$el.data('timeline-type',params.type);
            return this;
        },
        ready:function (e) {
            window.DTVCTimeline.__super__.ready.call(this, e);
            return this;
        },
        changeShortcodeParams:function (model) {
        	window.DTVCTimeline.__super__.changeShortcodeParams.call(this, model);
	...
	window.DTVCTimelineItem = window.VcTabView.extend({
		render:function () {
            window.DTVCTimelineItem.__super__.render.call(this);
            return this;
        },
        ready:function (e) {
            window.DTVCTimelineItem.__super__.ready.call(this, e);
            return this;
        },
        changeShortcodeParams:function (model) {
        	window.DTVCTimelineItem.__super__.changeShortcodeParams.call(this, model);
        	var params = model.get('params');
